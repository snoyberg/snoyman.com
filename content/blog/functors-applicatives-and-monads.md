...
1.  Implement `fmap` using `<*>` and `return`.
    ...
    <a role="button" data-toggle="collapse" data-parent="#accordion-473" href="#exerciseOne" aria-expanded="true" aria-controls="collapseOne">
    Show Solution
    </a>
    </h3>
    </div>
...
2.  How is `return` implemented for the `Maybe` monad? Try replacing `return`
    ...
    <div class="panel-heading" role="tab">
    <h3 class="panel-title">
    <a role="button" data-toggle="collapse" data-parent="#accordion-506" href="#exerciseTwo" aria-expanded="true" aria-controls="collapseTwo">
    Show Solution
    </a>
    </h3>
    </div>
...
4.  It's possible to write an applicative functor version of the
    ...
    <div class="panel-heading" role="tab">
    <h3 class="panel-title">
    <a role="button" data-toggle="collapse" data-parent="#accordion-599" href="#exerciseFour" aria-expanded="true" aria-controls="collapseFour">
    Show Solution
    </a>
    </h3>
    </div>
...
5.  Now try to do it without modifying `yearDiff` directly, but by
    ...
    <div class="panel-heading" role="tab">
    <h3 class="panel-title">
    <a role="button" data-toggle="collapse" data-parent="#accordion-641" href="#exerciseFive" aria-expanded="true" aria-controls="collapseFive">
    Show Solution
    </a>
    </h3>
    </div>
